...
//
//     final getproductsByCategories = getproductsByCategoriesFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

GetproductsByCategories getproductsByCategoriesFromJson(String str) => GetproductsByCategories.fromJson(json.decode(str));

String getproductsByCategoriesToJson(GetproductsByCategories data) => json.encode(data.toJson());
...
class GetproductsByCategories {
  ...
  factory GetproductsByCategories.fromJson(Map<String, dynamic> json) => GetproductsByCategories(
    status: json["status"],
